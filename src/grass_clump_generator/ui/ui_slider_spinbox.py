...
class SliderSpinBox:
    ...
    def on_slider_changed(self):
        ...
        persitent_settings.write_value(
            persitent_settings.HEADER_UI_VALUES, self.name, str(self.slider.value())
        )

    def on_spinbox_changed(self):
        self.slider.setValue(self.spinbox.value())
        persitent_settings.write_value(
            persitent_settings.HEADER_UI_VALUES, self.name, str(self.spinbox.value())
        )
    ...
    def set_default_values(self):
        ...
        if persitent_settings.read_value(persitent_settings.HEADER_UI_VALUES, self.name):
            self.value = int(persitent_settings.read_value(persitent_settings.HEADER_UI_VALUES, self.name))
